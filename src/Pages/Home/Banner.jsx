const Banner = () => {
   return (
      <div>
         <div className="hero h-[70vh]" style={{backgroundImage: 'url(https://images.pexels.com/photos/5935254/pexels-photo-5935254.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)'}}>
            ...
            <div className="hero-content text-center text-neutral-content">
               <div className="max-w-screen-md">
                  ...
                  <button className="btn bg-orange-600 border-none text-xl py-3 px-5 btn-primary hover:bg-orange-700 text-white">Get Started</button>
               </div>
            </div>
         </div>
      </div>
